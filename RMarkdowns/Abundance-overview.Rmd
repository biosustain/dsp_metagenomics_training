...
# Save it as a pdf
ggsave("results/report/03_Abundance-overview/01_top10_species.pdf",
       width = 8, height = 6)
```
...
# Adding the species name for the plot
abundance_summary$Species_name <- annotation$species[match(abundance_summary$Species,
                                                  rownames(annotation))]
...
# Save it as a pdf
ggsave("results/report/03_Abundance-overview/02_top10_species_per_area_sampling.pdf",
       width = 8, height = 6)
