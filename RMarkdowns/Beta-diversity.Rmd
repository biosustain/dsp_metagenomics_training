...
ggsave("results/report/02_Beta-diversity/04_dispersion_plot.pdf",
       width = 6, height = 4)
```
...
ggsave("results/report/02_Beta-diversity/05_dispersion_plot_sampling.pdf",
       width = 5, height = 4)
```
...
write.table(adonis_table, file = "results/report/02_Beta-diversity/06_Adonis_table.xlsx",
