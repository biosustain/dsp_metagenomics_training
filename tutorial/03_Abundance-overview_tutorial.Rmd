...
# Save it as a png
ggsave("results/report/03_Abundance-overview/02_top10_species_per_area_sampling.png", width = 8, height = 6, dpi = 300)

```

<div class="tip">
  <strong>💡 Tip:</strong> You can play with all the codes and parameters, ex: plot the top 50 taxa.
</div>
